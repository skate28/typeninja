export function LogoIcon({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      ...
      />
      <path
        d="M16 6 L22 16 L16 14 L10 16 Z"
        fill="#4ade80"
        opacity="0.9"
      />
      <text
...
export function CrownIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M5 16L3 5l5.5 5L12 4l3.5 6L21 5l-2 11H5zm2.7-2h8.6l.9-5.4-2.1 1.9L12 8l-3.1 2.5-2.1-1.9L5.7 14z" />
    </svg>
  );
}
...
export function RestartIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function GitBranchIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M17 7c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1zm-5 4c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1zm3-9C9.48 2 5 6.48 5 12c0 2.76 1.12 5.26 2.93 7.07l1.42-1.42C7.53 16.67 7 14.41 7 12c0-2.76 2.24-5 5-5s5 2.24 5 5-2.24 5-5 5c-.55 0-1 .45-1 1s.45 1 1 1c3.31 0 6-2.69 6-6s-2.69-6-6-6z" />
    </svg>
  );
}
...
export function NinjaStarIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
